    ...
    <div class="container">
        <header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
            ...
            <ul class="nav nav-pills">
                <li class="nav-item"><a id="btn1" href="cliente.php" class="btn btn-outline-warning">Clientes <i class="bi bi-box-arrow-left"></i></a></li>
            </ul>

            <ul class="nav nav-pills">
                <li class="nav-item"><a id="btn1" href="principal.php" class="btn btn-outline-danger" onclick="cerrarVentana()">Inicio <i class="bi bi-box-arrow-left"></i></a></li>
            </ul>
        </header>
    </div>
    <script>
